    ...
    def run(self):
        ...
        while True:
            ...
            pygame.draw.rect(
                ...
                consts.LIGHT_GREY,
                [
                    self.width * player_pos,
                    self.height * player_pos,
                    _length,
                    move_parameter,
                ],
            )
            screen.blit(
                player_text,
                (self.width * player_pos + _width / 2, self.height * player_pos),
            )
            ...
            pygame.draw.rect(
                ...
                consts.LIGHT_GREY,
                [
                    self.width * player_pos + self.width / 2,
                    self.height * player_pos,
                    _length,
                    move_parameter,
                ],
            ...
            screen.blit(
                host_text,
                (
                    self.width * player_pos + _width / 2 + self.width / 2,
                    self.height * player_pos,
                ),
            )
